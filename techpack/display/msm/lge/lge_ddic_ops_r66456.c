...
//		lge_set_ace_r66456(panel, panel->lge.irc_current_state, panel->lge.hdr_mode, panel->lge.ve_hdr);
...
static void lge_bc_dim_set_r66456(struct dsi_panel *panel, u8 bc_dim_en, u8 bc_dim_f_cnt)
{
	char *payload = NULL;
	u8 data = 0;
...
static int lge_get_brightness_dim_r66456(struct dsi_panel *panel)
{
	u8 bc_dim_f_cnt;
	char *payload = NULL;
...
static void lge_set_brightness_dim_r66456(struct dsi_panel *panel, int input)
{
	u8 bc_dim_f_cnt;
	...
	if (input == BC_DIM_OFF) {
		pr_warn("r66456 do not off bc_dim feature\n");
	...
	lge_bc_dim_set_r66456(panel, BC_DIM_ON, bc_dim_f_cnt);
}
...
static void lge_set_screen_mode_r66456(struct dsi_panel *panel, bool send_cmd)
{
	...
	lge_display_control_store_r66456(panel, send_cmd);
    return;
}
...
static void lge_set_custom_rgb_r66456(struct dsi_panel *panel, bool send_cmd)
{
...
struct lge_ddic_ops r66456_ops = {
	...
	.lge_bc_dim_set = lge_bc_dim_set_r66456,
	.lge_set_therm_dim = NULL,
	.lge_get_brightness_dim = lge_get_brightness_dim_r66456,
	.lge_set_brightness_dim = lge_set_brightness_dim_r66456,
	/* To Do : Image Quality */
	.hdr_mode_set = hdr_mode_set_r66456,
	.lge_set_custom_rgb = lge_set_custom_rgb_r66456,
